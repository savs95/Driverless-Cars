...
public class TestTraffic {
	...
	public void startGui() {
		...
		r1 = new SafeRoadMe(RoadGrid.EAST, i1, i2);
		r2 = new SafeRoadMe(RoadGrid.SOUTH, i2, i3);
		r2.setSpeedLimit(100);
		r3 = new SafeRoadMe(RoadGrid.SOUTH, i3, i4);
		r4 = new SafeRoadMe(RoadGrid.EAST, i5, i4);
		r5 = new SafeRoadMe(RoadGrid.EAST, i6, i5);
		r6 = new SafeRoadMe(RoadGrid.SOUTH, i7, i6);
		r6.setSpeedLimit(60);
		r7 = new SafeRoadMe(RoadGrid.EAST, i7, i8);
		r8 = new SafeRoadMe(RoadGrid.SOUTH, i1, i8);
		r8.setSpeedLimit(10);
		r9 = new SafeRoadMe(RoadGrid.EAST, i8, i3);
		r9.setSpeedLimit(40);
		r10 = new SafeRoadMe(RoadGrid.SOUTH, i8, i5);
	...
	public static void main(String[] args) {
		final TestTraffic mainActivity = new TestTraffic();
